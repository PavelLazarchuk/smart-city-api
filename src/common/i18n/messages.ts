export const ERROR_CODES = {
    ...
    SERVICE_NOT_PUBLISHED: 'SERVICE_NOT_PUBLISHED',
    ...
    BOOKING_FIELDS_INVALID: 'BOOKING_FIELDS_INVALID',
...
export const errorMessages: Record<ErrorCode, string> = {
    ...
    PASSWORD_TOO_WEAK:
        'The password must contain a lowercase letter, an uppercase letter, a digit and a special character.',
    ...
    IMAGE_TOO_LARGE: 'The image resolution is too large.',
